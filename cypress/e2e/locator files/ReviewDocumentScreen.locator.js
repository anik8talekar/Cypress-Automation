class ReviewDocumentScreenLocators {
    REVIEW_ICON = "//tr[@aria-rowindex='1']//td[@aria-colindex='2']//a[@awmtooltip='Review']"
    SCHEDULE_DROPDOWN = "//trux-input[@class='review-toolbar__view-by-input trux-input-select']//input[@placeholder='Select...']"
    ...
    HIDE_UNHIDE_ZERO_VALUES_TOGGLE_BTN = ".blank-values-toggle > trux-toggle > .trux-switch > .trux-switch__content > .trux-switch__handler"
    NOTES_ICON = "(//mezz-action-icon[@tooltip='Notes']//a[@class='action-icon'])[8]"
...
export default ReviewDocumentScreenLocators